...
MODALITY_INFO = {
    ...
    'coords': {
        'vocab_size': 30_000,
        'encoder_embedding': partial(SequenceEncoderEmbedding, vocab_size=30_000, max_length=2, padding_idx=0),
        'decoder_embedding': partial(SequenceDecoderEmbedding, vocab_size=30_000, max_length=2, padding_idx=0),
        'min_tokens': 0,
        'max_tokens': 2,
        'type': 'seq',
