...
MultiMAE code has a non-commerical license! See https://github.com/EPFL-VILAB/MultiMAE/blob/main/LICENSE
"""
import logging
import warnings
...
def multimae_large(
    ...
    **kwargs,
    ...
    warnings.warn("MultiMAE code has a non-commerical license! See https://github.com/EPFL-VILAB/MultiMAE/blob/main/LICENSE")
