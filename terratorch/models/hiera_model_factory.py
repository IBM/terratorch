...
@register_factory
class HieraModelFactory(ModelFactory):
    def build_model(
        self,
        task: str,
        ...
        **kwargs,
        ...
        """Model factory for hiera models.
        ...
        if not isinstance(backbone, nn.Module):
            if not backbone.startswith("hiera_"):
                msg = "This class only handles models for `hiera` encoders"
            ...
            # Extracting the model parameters from the config file (yaml)
        ...
        # Extracting the decoder parameters from the config file (yaml)
