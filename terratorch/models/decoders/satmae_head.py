...
class SatMAEHead(nn.Module):
    def __init__(
        ...
        self.decoder_pos_embed = nn.Parameter(
            torch.zeros(1, self.num_patches + 1, self.output_embed_dim), requires_grad=False
        ...
        self.decoder_pred = nn.Linear(
            self.output_embed_dim, self.patch_size**2 * self.in_chans, bias=True
        )  # decoder to patch
