...
def _get_backbone(backbone: str | nn.Module, **backbone_kwargs) -> nn.Module:
    ...
    temporal_stack_in_progress = backbone_kwargs.pop('temporal_stack_in_progress', None)
    ...
    if use_temporal:
        model = TemporalWrapper(model, pooling=temporal_pooling, concat=concat, temporal_stack_in_progress=temporal_stack_in_progress)
