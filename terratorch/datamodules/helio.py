...
try:
    from surya.downstream_examples.ar_segmentation.dataset import ArDSDataset
except ImportError:
    print("It's necessary to instal the package `terratorch_surya` to allow the importing of these datasets")
...
class ArDSDataModule(NonGeoDataModule):
    """NonGeo LightningDataModule implementation for the Heliophysics Ar segmentation case."""
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        super().__init__(ArDSDataset, batch_size, num_workers, **kwargs)
